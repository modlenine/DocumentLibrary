...
<body>
    <div class="app-main__outer">
        ...
        <form action="<?=base_url('document/save_sec4cancel/'.$getF->dc_data_darcode);?>" method="POST" enctype="multipart/form-data">
            <div class="form-row">
                <label for="">ยืนยันการยกเลิกเอกสารด้วยการดาวน์โหลดไฟล์ต้นฉบับนี้ :</label>&nbsp;<label for=""><a href="<?=base_url()?><?=$getF->dc_data_file_location.$getF->dc_data_file;?>" target="_blank"><?=$getF->dc_data_file;?></a></label>
                <input hidden type="text" name="dc_data_file" id="dc_data_file" value="<?=$getF->dc_data_file;?>"/>
            </div>
            
            <div class="form-row">
                <label for="">ไปทำลายน้ำ ยกเลิกเอกสาร จากนั้นอัพโหลดเข้าระบบอีกครั้ง เพื่อเก็บไว้เป็นข้อมูล</label>
            </div>
            ...
            <div class="form-row">
                <label for="">หลังจากกดบันทึก ระบบจะทำการลบไฟล์ที่แจกจ่ายไปทั้งหมดออกจากระบบ</label>
            </div>
...
?>
            ...
            <input type="text" name="get_dc_data_doccode" id="get_dc_data_doccode" value="<?=$getF->dc_data_doccode;?>" />
            <input type="text" name="get_dc_data_old_dar" id="get_dc_data_old_dar" value="<?=$getF->dc_data_old_dar;?>">
            <input type="text" name="get_dc_data_file" id="get_dc_data_file" value="<?=$getF->dc_data_file;?>">
        </form>
