    ...
    <div class="app-main__outer">
        ...
        <div class="app-main__inner mb-5">
            ...
            <div class="container-fulid border p-4 bg-white">
                ...
                <form action="<?= base_url('document/save_sec1_edit/') . $get_fulldatas->dc_data_doccode; ?>" method="POST" name="form1" id="form1" enctype="multipart/form-data">
                    <!-- Form Section 1 -->
                    <!-- Get Form Code -->
            ...
            <div class="form-row">
                <?php foreach ($get_reason->result_array() as $rs_reason) { ?>
                    <!-- Reason request loop -->
                    <?php
                    if ($rs_reason['dc_reason_code'] == "r-04") {
                        $checked = ' checked="" ';
                    } else {
                        $checked = '';
                    }
